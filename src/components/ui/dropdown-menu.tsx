...
interface DropdownMenuCheckboxItemCustomProps {
  direction?: string;
}
...
const DropdownMenuCheckboxItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.CheckboxItem> &
    DropdownMenuCheckboxItemCustomProps
>(({ className, children, checked, direction, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      `${
        direction == "right" ? "pr-8 pl-2" : "pl-8 pr-2"
